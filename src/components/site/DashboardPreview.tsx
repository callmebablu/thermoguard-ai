...
export function DashboardPreview() {
  return (
    <section id="dashboard" className="mt-24 sm:mt-32 lg:mt-40">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          eyebrow="Inside the platform"
          title="One operational view of thermal risk across your sites."
          description="A primary trend view supported by alerts, recommended actions, and asset-level risk context."
        />
        ...
        <div className="reveal panel-strong mt-12 p-3 sm:p-5">
          ...
          <div className="mb-4 flex flex-wrap items-center justify-between gap-2 border-b border-[var(--hairline)] pb-3">
            ...
            <div className="flex items-center gap-2">
              <button className="hidden items-center gap-1.5 rounded-md border border-[var(--hairline)] bg-elevated/60 px-2.5 py-1 text-xs text-muted-foreground hover:text-foreground sm:inline-flex">
          ...
          <div className="mt-4 grid gap-4 lg:grid-cols-3">
            <div className="panel-inset p-4 ring-1 ring-primary/15 lg:col-span-2">
              <div className="flex items-start justify-between gap-2">
                ...
                <div className="flex items-center gap-1">
                  {["A", "B", "C"].map((p) => (
                    <span
                      key={p}
                      className={`text-mono rounded px-1.5 py-0.5 text-[11px] ${
                        p === "B"
              ...
              <div className="mt-3 relative">
                ...
                />
                <div className="pointer-events-none absolute right-2 top-1 text-mono text-[11px] uppercase text-[var(--risk-elevated)]/80">
                  · · · Baseline +10°C
                </div>
              </div>
            </div>
                ...
                {alerts.map((a, i) => (
                  <li key={i} className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <span
                        className={`mt-1 inline-flex rounded-full px-2 py-0.5 text-[11px] uppercase ring-1 ${statusTone(
                          a.status,
                        )}`}
                      >
                        {a.status}
...
function Stat({
  ...
  return (
    <div className="panel p-4">
      ...
      <div
        className={`mt-1 text-mono text-2xl font-semibold sm:text-3xl ${
