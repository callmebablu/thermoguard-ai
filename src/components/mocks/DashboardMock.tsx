    ...
    <div className="panel-strong relative overflow-hidden p-4 sm:p-5">
      ...
      <div className="mb-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="ml-3 hidden text-mono text-xs text-muted-foreground md:inline">
      ...
      <div className="pointer-events-none absolute right-4 top-14 hidden w-[240px] xl:block">
        <div className="panel p-3">
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-medium uppercase text-[var(--risk-critical)]">
              Critical alert
            </span>
